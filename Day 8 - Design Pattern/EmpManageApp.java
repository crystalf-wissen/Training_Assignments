                ...
                case 1:
                    do {
                        ...
                        try {
                            switch (ch2) {
                                case 1:
                                    emp[Emp.countEmp] = EmpFactory.createEmployee("CEO");
                                    break;
                                case 2:
                                    emp[Emp.countEmp] = EmpFactory.createEmployee("Clerk");
                                    break;
                                case 3:
                                    emp[Emp.countEmp] = EmpFactory.createEmployee("Programmer");
                                    break;
                                case 4:
                                    emp[Emp.countEmp] = EmpFactory.createEmployee("Manager");
                                    break;
                            }
